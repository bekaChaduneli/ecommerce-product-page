...
addCart.addEventListener("click", ()=> {
    ...
    elem.innerHTML = `
        <img class = "buy-image" src = ${document.querySelector(".menu").style.display == "flex"? images.src : document.querySelector(".desktop-images-main-image").src}>
        <div class = "buy-description">
            <span class = "buy-name">
                Fall Limited Edition Sneakers
            </span>
            <span class = "price-box">
                $125.00 x ${Number(document.querySelector(".count").innerHTML)} <span class = "price">${document.querySelector(".real-price").innerHTML}</span>
            </span>
            </div>
